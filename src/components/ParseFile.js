...
export const ParseFile = (file) =>{
    ...
    var ParametersNamesRegex = /^(\d{3}|\d{1}|\d{2})\,([^0]|[0-9][0-9])\,(.*)/gm;//001,1,Voltage Supply,(Terminal 15),Specifcation: 0.0...15.0 V or 1,1,Switch OFF status,0=OK 7=Man. OFF
    var ParametersNames = [
    ...
    var AdaptationsNamesRegex = /^\A(\d{3}|\d{2})\,([^0])\,(.*)/gm;
    ...
    var CodingsNamesRegex = /^C(\d\d)\,(.*)/gm; //C01,??xxx: Equipment
    var CodingsNames = [
